    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden '>
      ...
      <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
        {dummyTrailers.map((trailer)=>(
          <div key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:-translate-y-1 transition duration-300
          ...
          ' onClick={()=>setCurrentTrailer(trailer)}>
            ...
            <PlayCircleIcon strokeWidth={1.6} color='white' className='absolute top-1/2 left-1/2 w-5 md:w-8 h-5 md:h-12 transform -translate-x-1/2 -translate-y-1/2 text-white'/>
          </div>
        ))}
